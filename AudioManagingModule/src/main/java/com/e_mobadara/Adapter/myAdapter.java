package com.example.rick.tictactoe.Adapter;
...
public class myAdapter extends RecyclerView.Adapter<myAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        viewHolder.txtViewTitle.setText(_itemsData.get(position).getaName());
        viewHolder.txtViewDesc.setText(_itemsData.get(position).getaPath());
    }
